...
import { usePostCardFinal } from "../../../../../hooks/usePostCardFinalBusiness";
const Page5 = ({ pages, changePage }) => {
  ...
  const submitForm = () => {
      const finalObject = {
       ...
       mutate(finalObject);
       console.log('Card data posted successfully!');
      changePage();
  };
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center">
          <CardTest color={user.cardColor} background={background} name={user.name} description={user.description} hook={user.hook} object={user.object} core={user.core}></CardTest>
