    ...
    <div className="bg-white rounded-t-[30px] xl:w-[90%] 2xl:h-screen mx-auto w-full h-auto overflow-y-hidden">
      ...
      <div className="pt-[1rem] pb-10">
        <ButtonRequest
          text={"Continua"}
          onClick={changePage}
          disabled={!inputEnabled || user.description.length === 0 || user.workPreference === null || user.identifyCreativeType === null 
          || user.professionalRelationship === null || user.educationalBackground === null || user.experienceLevel === null}
        />
      </div>
    </div>
  );
