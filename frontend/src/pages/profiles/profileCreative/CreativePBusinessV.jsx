...
import CreativeProfileImage from "./CreativeProfileImage";
import CreativeProfileDescription from "./CreativeProfileDescription";
...
export default function CreativePBusinessV() {
      ...
      <div className="w-full min-w-[24.375rem] min-h-screen bg-white">
        <div className="max-w-[24.375rem] m-auto bg-white pt-[1.06rem] px-[.69rem] pb-[7rem]">
          ...
          <div className="pageMain">
            {count === 1 ? (
              <CreativeProfileImage count={count} setCount={setCount} />
            ) : null}
            {count === 2 ? (
              <CreativeProfileDescription count={count} setCount={setCount} />
            ) : null}
          </div>
          ...
          <div className="flex flex-col gap-[1.88rem]">
            ...
            <div className="mt-[1.88rem]">
              <h3 className="text-[1.25rem] font-montserrat font-semibold flex flex-col gap-[.88rem] pl-2 mb-[.87rem]">
                💡 I Progetti
              </h3>
              <div className="flex gap-[.62rem] p-2">
                <div className="">
                  <CreativeProjectImg1 />
