    ...
    <>
      ...
      <div className="w-full min-w-[24.375rem] min-h-screen bg-white">
        <div className="max-w-[24.375rem] m-auto bg-white pt-[1.06rem] px-[.69rem]">
          ...
          <div className="w-[9.375rem] h-[3.3125rem] m-auto mt-[1.56rem]">
            <button className="w-full text-[1rem] text-primary-color font-medium shadow-btn-creative-save-box-shadow px-[2.19rem] py-[.94rem] rounded-[.5625rem]">
              Salva carta
            </button>
          </div>
          {/* Recapiti */}
